                ...
                StreamBuilder<List<RidesRecord>>(
                  stream: queryRidesRecord(
                    queryBuilder: (ridesRecord) => ridesRecord
                        .where(
                          'category',
                          isEqualTo: _model.choiceChipsValue == 'All'
                              ? null
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, listViewIndex) {
                        ...
                        return EventCardWidget(
                          key: Key(
                              'Keytro_${listViewIndex}_of_${listViewRidesRecordList.length}'),
                          rideDocument: listViewRidesRecord,
                        );
                      },
                    );
                  },
