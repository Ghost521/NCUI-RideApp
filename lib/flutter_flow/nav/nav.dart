...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const Authentication1Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/profileMain',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'profile_Main')
        ...
        FFRoute(
          name: 'create_Ride',
          path: '/createRide',
          builder: (context, params) => const CreateRideWidget(),
        ),
        FFRoute(
          name: 'details_ride',
          path: '/detailsRide',
